...
const ALLOWED_PROSE_FILES = new Set([
  ...
  'zero-content.md',
  'example-dx.md',
  // Generated Troubleshooting "Documentation Mistakes" page — quotes the
  // deprecated `<Playground>` (in a code-span) as an anti-pattern to avoid.
  // Generated by docs/scripts/gen-troubleshooting.ts from anti-patterns.md.
  'documentation.md',
])
