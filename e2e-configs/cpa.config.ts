...
export default definePlaywrightConfig({
  ...
  webServer: [
    viteDevServer('@pyreon/example-cpa-pw-app', 5191, { strictPort: false }),
    viteDevServer('@pyreon/example-cpa-pw-blog', 5192, { strictPort: false }),
    viteDevServer('@pyreon/example-cpa-pw-dash', 5193, { strictPort: false }),
    viteDevServer('@pyreon/example-cpa-pw-app-react', 5194, { strictPort: false }),
    viteDevServer('@pyreon/example-cpa-pw-app-vue', 5195, { strictPort: false }),
    viteDevServer('@pyreon/example-cpa-pw-app-solid', 5196, { strictPort: false }),
    viteDevServer('@pyreon/example-cpa-pw-app-preact', 5197, { strictPort: false }),
  ],
})
