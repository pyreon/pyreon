...
Plus `docs/` (Pyreon-native docs site on @pyreon/zero + @pyreon/zero-content — 195 doc pages covering all packages, `<Example>` live-mount primitive, dogfoods the framework) and `examples/`.
