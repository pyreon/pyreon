...
| `@pyreon/lint`           | Pyreon-specific linter — 65 rules, 13 categories, config files, watch mode, AST cache, LSP server                                                       |
...
- `listRules()` — returns metadata for all 65 rules
...
- 65 rules across 13 categories: reactivity (12), jsx (11), lifecycle (5), performance (4), ssr (3), architecture (7), store (3), form (3), styling (4), hooks (3), accessibility (3), router (4), ssg (3)
