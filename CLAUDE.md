...
Plus `docs/` (Pyreon-native docs site on @pyreon/zero + @pyreon/zero-content — 198 doc pages covering all packages, `<Example>` live-mount primitive, dogfoods the framework) and `examples/`.
