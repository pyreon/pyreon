...
<Playground title="Reactive i18n" :height="80">
const locale = signal('en')
const messages = { en: { hello: 'Hello World!', btn: 'Switch to German' }, de: { hello: 'Hallo Welt!', btn: 'Switch to English' } }
const t = (key) => messages[locale()]?.[key] ?? key

const app = document.getElementById('app')
const ui = h('div', {},
  h('h2', { style: { margin: '0 0 8px' } }, () => t('hello')),
  h('button', { onClick: () => locale.set(locale() === 'en' ? 'de' : 'en') }, () => t('btn')),
)
mount(ui, app)
</Playground>
