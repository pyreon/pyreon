---
title: '@pyreon/lint'
description: Pyreon-specific linter — 86 rules for signals, JSX, SSR, performance, architecture, routing, SSG, and opt-in best practices (frontend a11y/CLS, query/rx/form/i18n/router/storage library usage).
---
