...
<template>
  ...
  >
    ...
    <svg v-if="variant === 'trace'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
    ...
    <!-- 02 · Pulse cascade -->
    <svg v-else-if="variant === 'pulse'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
    ...
    <!-- 03 · Wavefront sweep -->
    <svg v-else-if="variant === 'wave'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
    ...
    >
      ...
      <circle
        ...
        r="4"
        fill="#FF5E1A"
        style="--fx: -30px; --fy: 200px; --d: 120ms"
      />
      <circle
        class="pyr-part"
        cx="210"
      ...
      <circle
        ...
        r="3"
        fill="#FFC83D"
        style="--fx: 380px; --fy: 340px; --d: 180ms"
      />
      <circle
        class="pyr-part"
        cx="210"
      ...
      <circle
        ...
        r="4"
        fill="#FFC83D"
        style="--fx: 420px; --fy: 120px; --d: 50ms"
      />
      <g transform="translate(138 72) scale(2)">
    ...
    <!-- 05 · Ember bead fuse -->
    <svg v-else-if="variant === 'fuse'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
    ...
    <!-- 06 · Terminal type-on -->
    <svg v-else-if="variant === 'term'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
      ...
      <g transform="translate(405 125)">
        <text
          x="0"
          y="0"
          style="font-family: 'JetBrains Mono', monospace; font-size: 18px; fill: #22d3ee"
        >
          $
        </text>
        <g class="pyr-term-clip">
          <text
            x="20"
            y="0"
            style="font-family: 'JetBrains Mono', monospace; font-size: 18px; fill: #f4efe6"
          >
            pyr show-mark
          </text>
        </g>
    ...
    <!-- 07 · Concentric rings -->
    <svg v-else-if="variant === 'rings'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
    ...
    <!-- 08 · Orbit collapse -->
    <svg v-else-if="variant === 'orbit'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
      ...
      <circle
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 0deg; --d: 0ms"
      />
      <circle
        class="pyr-orbiter"
        cx="210"
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 45deg; --d: 25ms"
      />
      <circle
        class="pyr-orbiter"
        cx="210"
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 90deg; --d: 50ms"
      />
      <circle
        class="pyr-orbiter"
        cx="210"
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 135deg; --d: 75ms"
      />
      <circle
        class="pyr-orbiter"
        cx="210"
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 180deg; --d: 100ms"
      />
      <circle
        class="pyr-orbiter"
        cx="210"
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 225deg; --d: 125ms"
      />
      <circle
        class="pyr-orbiter"
        cx="210"
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 270deg; --d: 150ms"
      />
      <circle
        class="pyr-orbiter"
        cx="210"
        ...
        r="4"
        fill="#22D3EE"
        style="transform-origin: 210px 200px; --a: 315deg; --d: 175ms"
      />
      <g transform="translate(138 72) scale(2)">
    ...
    <svg v-else-if="variant === 'split'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
    ...
    <!-- 10 · Spotlight focus -->
    <svg v-else-if="variant === 'spot'" viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
    ...
    <!-- 11 · ECG sync sweep -->
    <svg v-else viewBox="0 0 720 360" preserveAspectRatio="xMidYMid meet">
      <defs>
