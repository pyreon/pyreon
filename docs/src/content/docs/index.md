...
| [@pyreon/hooks](/docs/hooks)                             | 65 signal-based hooks for common UI patterns                        |
...
| [@pyreon/charts](/docs/charts)     | Charts on web, iOS and Android, plus a [lazy ECharts wrapper](/docs/charts-echarts) |
