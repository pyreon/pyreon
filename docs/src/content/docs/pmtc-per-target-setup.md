...
Limitations of the scaffolder are documented in [`docs/src/content/docs/create-multiplatform.md`](./create-multiplatform.md). If you outgrow it, fall back to one of the integration paths below.
