...
```tsx
import { extractStyleVar, cpseVarName, cpseRewrite } from '@pyreon/unistyle'
...
**See also:** `cpseStyled` · `themeToCssVars`
...
**See also:** `cpseRewrite / cpseVarName / extractStyleVar`
