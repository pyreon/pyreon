---
title: "URL State — API Reference"
description: "URL-synced state — useUrlState(key, default) or schema mode, auto type coercion, SSR-safe"
---
...
| [`setUrlRouter`](#seturlrouter) | function | Configure useUrlState to use a @pyreon/router instance for URL updates instead of raw `history.replaceState`. |
