...
description: "Pyreon-specific linter — 132 rules across 25 categories, config files, watch mode, AST cache, CLI + LSP"
---
...
| Symbol | Kind | Summary |
| --- | --- | --- |
| [`lint`](#lint) | function | 132 rules across 25 categories. |
