...
description: "Pyreon-specific linter — 116 rules across 25 categories, config files, watch mode, AST cache, CLI + LSP"
---
...
//   pyreon-lint --list                                     # list all 116 rules
...
| Symbol | Kind | Summary |
| --- | --- | --- |
| [`lint`](#lint) | function | 116 rules across 25 categories. |
