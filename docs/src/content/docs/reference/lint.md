...
description: "Pyreon-specific linter — 102 rules across 20 categories, config files, watch mode, AST cache, CLI + LSP"
---
...
| Symbol | Kind | Summary |
| --- | --- | --- |
| [`lint`](#lint) | function | 102 rules across 20 categories. |
