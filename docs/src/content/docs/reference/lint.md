...
description: "Pyreon-specific linter — 101 rules across 20 categories, config files, watch mode, AST cache, CLI + LSP"
---
...
| Symbol | Kind | Summary |
| --- | --- | --- |
| [`lint`](#lint) | function | 101 rules across 20 categories. |
