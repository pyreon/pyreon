...
description: "Pyreon-specific linter — 131 rules across 25 categories, config files, watch mode, AST cache, CLI + LSP"
---
...
| Symbol | Kind | Summary |
| --- | --- | --- |
| [`lint`](#lint) | function | 131 rules across 25 categories. |
