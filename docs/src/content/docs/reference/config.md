---
title: "Ecosystem Config — API Reference"
description: "One `pyreon.config.ts` for the whole ecosystem — a typed section per package"
---
...
**See also:** `CONFIG_FILENAMES` · `sectionFrom`
...
**See also:** `sectionFrom` · `defineConfig`
...
```tsx
import { sectionFrom } from '@pyreon/config'
...
**See also:** `CONFIG_FILENAMES` · `defineConfig`
