...
**See also:** `useRouter` · `RouterProvider` · `createRouter`
...
```tsx
safeRedirectLocation('/dashboard')           // '/dashboard'
...
**See also:** `redirect` · `isRedirectError` · `getRedirectInfo`
...
**See also:** `useLoaderData` · `prefetchLoaderData`
...
```tsx
import { resolveRoute, buildPath, parseQueryMulti } from '@pyreon/router'
...
**See also:** `createRouter` · `useRoute`
