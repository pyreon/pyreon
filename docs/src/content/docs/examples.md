---
title: "Examples"
description: "A gallery of 52 runnable Pyreon examples — every one mounted live on this page, grouped by topic."
---

# Examples

Every example below is a **real, typechecked Pyreon component mounted live on this page** — no sandbox, no install. 52 examples across 32 topics. (Generated from `docs/src/examples/` by `docs/scripts/gen-examples-gallery.ts`.)
