...
test.describe("Framework Comparison Benchmark", () => {
  test("run all framework benchmarks in isolated pages", async ({ browser }) => {
    ...
    const frameworkNames = ["Vanilla JS", "Preact", "React 19", "Vue 3", "SolidJS", "Pyreon", "Pyreon (compiled)"]
    ...
    const displayOrder = ["Vanilla JS", "Preact", "React 19", "Vue 3", "SolidJS", "Pyreon", "Pyreon (compiled)"]
