...
New exported type `UseInfiniteQueryOptions<TQueryFnData, TError, TQueryKey, TPageParam>` — the options `useInfiniteQuery` takes, so a wrapper or an options factory is typed without importing query-core.
