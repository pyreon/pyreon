...
'@pyreon/devtools': patch
---

fix(reactive-devtools): always-register in `__DEV__` so the Foundation surfaces a populated graph when devtools attaches AFTER mount
