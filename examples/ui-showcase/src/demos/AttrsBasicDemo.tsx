  ...
  return (
    <div>
      ...
      <Paragraph style="margin-bottom: 24px">
        attrs(component).attrs(...) injects default props into a component. Multiple .attrs() calls
        stack left-to-right — later calls override earlier ones.
      </Paragraph>

      <Title size="h3" style="margin-bottom: 12px">
        Single .attrs()
      </Title>
      <Box style={cardStyle}>Box has direction="rows", alignX/Y="center", block=true baked in.</Box>
