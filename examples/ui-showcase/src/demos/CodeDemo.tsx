  ...
  return (
    <div>
      ...
      <div style="margin-bottom: 24px;">
        <Paragraph>
          Use <Code variant="inline">signal()</Code> to create reactive state and{' '}
          <Code variant="inline">computed()</Code> for derived values. Call{' '}
          <Code variant="inline">effect()</Code> to run side effects.
        </Paragraph>
      </div>
