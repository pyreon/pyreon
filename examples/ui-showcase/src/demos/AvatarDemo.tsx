  ...
  return (
    <div>
      ...
      <div style="display: flex; gap: 12px; align-items: center; margin-bottom: 24px;">
        <Avatar size="xSmall" variant="circle">
          XS
        </Avatar>
        <Avatar size="small" variant="circle">
          SM
        </Avatar>
        ...
        <Avatar size="xLarge" variant="circle">
          XL
        </Avatar>
      </div>
      ...
      <div style="display: flex; gap: 12px; align-items: center; margin-bottom: 24px;">
        <Avatar size="xSmall" variant="rounded">
          XS
        </Avatar>
        ...
        <Avatar size="xLarge" variant="rounded">
          XL
        </Avatar>
      </div>
