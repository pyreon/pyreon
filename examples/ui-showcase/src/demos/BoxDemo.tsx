  ...
  return (
    <div>
      ...
      <Box style="display: flex; gap: 12px; margin-bottom: 24px;">
        <Box style="flex: 1; padding: 16px; background: #ede9fe; border-radius: 8px; text-align: center;">
          Column 1
        </Box>
        <Box style="flex: 1; padding: 16px; background: #fce7f3; border-radius: 8px; text-align: center;">
          Column 2
        </Box>
        <Box style="flex: 1; padding: 16px; background: #ecfccb; border-radius: 8px; text-align: center;">
          Column 3
        </Box>
      </Box>
    </div>
