  ...
  return (
    <div>
      ...
      <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px;">
        <Paragraph>
          This text contains a <Highlight state="primary">primary highlight</Highlight> for
          emphasis.
        </Paragraph>
        <Paragraph>
      ...
      <div style="margin-bottom: 24px;">
        <Paragraph>
          Pyreon's <Highlight state="primary">signal-based reactivity</Highlight> enables{' '}
          <Highlight state="success">fine-grained updates</Highlight> with{' '}
          <Highlight state="warning">zero unnecessary re-renders</Highlight>.
        </Paragraph>
      </div>
    </div>
  )
