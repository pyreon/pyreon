        ...
        {(state: FileUploadState) => (
          <div style="max-width: 400px;">
            <div
              ...
              style={() =>
                `border: 2px dashed ${state.isDragging() ? '#3b82f6' : '#d1d5db'}; border-radius: 12px; padding: 32px; text-align: center; cursor: pointer; background: ${state.isDragging() ? '#eff6ff' : '#f9fafb'}; transition: all 0.15s;`
              }
            >
