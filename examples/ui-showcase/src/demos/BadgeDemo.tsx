  ...
  return (
    <div>
      ...
      <div style="display: flex; gap: 8px; align-items: center; margin-bottom: 24px;">
        <Badge state="primary" size="small">
          Small
        </Badge>
        <Badge state="primary" size="medium">
          Medium
        </Badge>
        <Badge state="primary" size="large">
          Large
        </Badge>
      </div>
      ...
      <div style="display: flex; gap: 8px; margin-bottom: 24px;">
        <Badge state="primary" variant="solid">
          Solid
        </Badge>
        <Badge state="primary" variant="outline">
          Outline
        </Badge>
        <Badge state="primary" variant="subtle">
          Subtle
        </Badge>
      </div>
    </div>
