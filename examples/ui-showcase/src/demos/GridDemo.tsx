  ...
  return (
    <div>
      ...
      <Paragraph style="margin-bottom: 24px">
        12-column responsive grid from `@pyreon/coolgrid`. Supports breakpoint arrays, row-level
        sizes, custom column counts, and nesting.
      </Paragraph>

      <Title size="h3" style="margin-bottom: 12px">
        Equal columns (size on each Col)
      </Title>
      ...
      <Title size="h3" style="margin-bottom: 12px">
        Row-level size — applies to all Cols
      </Title>
      ...
      <Container style="margin-bottom: 24px;">
        <Row size={3}>
          <Col>
            <div style={cellStyle}>Auto 3</div>
          </Col>
          <Col>
            <div style={cellStyle}>Auto 3</div>
          </Col>
      ...
      <Container style="margin-bottom: 24px;">
        <Row>
          <Col size={[12, 6, 4, 3]}>
            <div style={cellStyle}>12/6/4/3</div>
          </Col>
          <Col size={[12, 6, 4, 3]}>
            <div style={cellStyle}>12/6/4/3</div>
          </Col>
          ...
          <Col size={6}>
            <div style={cellStyle}>
              ...
              <Container style="margin-top: 8px;">
                <Row>
                  <Col size={6}>
                    <div style={altCellStyle}>Inner 6</div>
                  </Col>
                  <Col size={6}>
                    <div style={altCellStyle}>Inner 6</div>
                  </Col>
