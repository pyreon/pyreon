  ...
  return (
    <div>
      ...
      <div style="display: flex; flex-direction: column; gap: 12px; max-width: 480px; margin-bottom: 24px;">
        ...
        <Notification state="success">Your changes have been saved successfully.</Notification>
      ...
      <div style="max-width: 480px; margin-bottom: 24px;">
        <Notification>This is a neutral notification with no specific state applied.</Notification>
      </div>
    </div>
  )
}
