...
//
// Uses canonical @pyreon/primitives vocabulary (Phase E migration):
...
// `<Toggle>` ships emit (deferred — needs a separate per-target emit
// function because Compose uses `Switch` not `Toggle`).
