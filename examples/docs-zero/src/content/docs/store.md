...
<Playground title="Counter store — signals + derived" height={220} code={`// A store is just signals + computeds + actions, scoped together.
...
<Playground title="Todo store — list + derived count" height={320} code={`const todos = signal([
