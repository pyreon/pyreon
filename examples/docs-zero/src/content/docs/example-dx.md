...
The component above lives at [`src/examples/effects-log.tsx`](https://github.com/pyreon/pyreon/blob/main/examples/docs-zero/src/examples/effects-log.tsx). It's real Pyreon source code:
