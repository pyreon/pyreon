// Ported from docs/.vitepress/config.ts `sidebar: { '/docs/': [...] }`.
//
// Single source of truth for the docs nav. The runtime `<Sidebar>` reads
// this directly so the order + grouping matches the legacy VitePress
// site exactly. Adding a new collection entry without updating this
// file just means the page exists but isn't linked from the sidebar
// (a follow-up doctor check could lint this).
