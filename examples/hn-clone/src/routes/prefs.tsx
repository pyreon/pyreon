  ...
  return (
    <>
      <Container>
          ...
          <Col col={12}>
            <Element tag="header" direction="rows" gap={2} block class="prefs-header">
              ...
              <Text tag="p" paragraph>
                Settings persist to localStorage. Density affects feed listings; auto-expand
                controls comment threads.
              </Text>
            </Element>
          </Col>
        </Row>
        ...
        <Row>
          <Col col={12} md={6}>
            <Element tag="section" class="prefs-card" direction="rows" gap={3} block>
        ...
        <Row>
          <Col col={12}>
            <Element tag="section" direction="rows" gap={2} block class="prefs-info">
      ...
      >
        ...
        >
          ...
          >
            ...
            <p>
              Animated with <code>{'<Transition>'}</code> + the <code>fade</code> preset from{' '}
