...
export const ToggleRoot = el.attrs({ tag: 'label', css: 'display:inline-flex;align-items:center;justify-content:center;' }).theme((t: T) => cx(`display:inline-flex;align-items:center;gap:11px;cursor:pointer;font-family:'Public Sans',sans-serif;color:${t.text};`))
