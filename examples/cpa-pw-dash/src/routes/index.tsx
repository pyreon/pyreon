...
export const meta = {
  ...
  description:
    'A SaaS-shape Pyreon Zero starter. Auth, invoices, users, settings — out of the box.',
}
  ...
  return (
    <>
      ...
      <section class="hero">
        ...
        <p>
          A Pyreon Zero starter with auth, table views, settings, and an invoice export pipeline
          that renders the same component tree to PDF and email.
        </p>
