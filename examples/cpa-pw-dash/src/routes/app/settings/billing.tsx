    ...
    <>
      ...
      <div class="stat-card" style="max-width: 480px;">
        ...
        <p style="margin-top: 1rem; font-size: 0.8125rem; color: var(--c-text-muted);">
          Wire Stripe Checkout into <code>/api/billing/checkout</code> in a follow-up. The dashboard
          template ships the UI shell — payment integration is intentionally left to the user since
