...
| [`@pyreon/hooks`](packages/fundamentals/hooks/) | 36 hooks — useHover, useFocus, useBreakpoint, useClipboard, useDialog, useTimeAgo, etc. |
...
| [`@pyreon/lint`](packages/tools/lint/) | 92 Pyreon-specific lint rules across 18 categories — reactivity, JSX, SSR, performance |
