...
**Revision history — five artifacts found in this repo's OWN benchmark harness during the 2026-08 campaign, every one of which had inflated a Pyreon number.** Each is retracted explicitly, not silently corrected, per this file's standing discipline:
