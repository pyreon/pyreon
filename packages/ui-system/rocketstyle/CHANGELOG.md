...
- fix(rocketstyle): resolve function-valued dimension props so INLINE reactive dimension props apply (8c7d231)
...
- `Theme<T>` now actually uses its type argument. (cfd2e8c)
