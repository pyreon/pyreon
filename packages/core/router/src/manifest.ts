...
<RouterLink to="https://github.com/pyreon">GitHub</RouterLink>{/* auto target=_blank + secure rel */}`,
      ...
      seeAlso: ['useRouter', 'useIsActive', 'createRouter'],
    },
    {
      name: 'useRouter',
      kind: 'hook',
...
// route().params.id re-reads on every navigation`,
      ...
      seeAlso: ['useRoute', 'useNavigate'],
    },
    {
      name: 'useValidatedSearch',
      kind: 'function',
      signature:
...
const page = () => search().page`,
      ...
      seeAlso: ['useTypedSearchParams', 'useSearchParams'],
    },
    {
      name: 'notFound / NotFoundBoundary',
      kind: 'function',
      signature:
