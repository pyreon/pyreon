    ...
    for (const r of records) {
      ...
      r.loader(loaderCtx)
        ...
        .catch((err: unknown) => {
          ...
          // the loader) would produce ZERO signal — the developer sees
          ...
          // value. Now reachable: until the SWR prune fix, this path was
          // dead code (`revalidateSwrLoaders` never ran).
          if (__DEV__) {
