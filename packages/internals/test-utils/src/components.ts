...
const resolve = (value: any): any => (typeof value === 'function' ? value() : value)
 ...
 */
export const ThemeCapture: any = ({ $rocketstyle, $rocketstate, ...rest }: any) => ({
  type: 'div',
  props: rest,
  children: [],
  key: null,
 ...
 */
export const BaseComponent: any = ({ children, $rocketstyle, $rocketstate, ...rest }: any) => {
