...
- fix(lathe): a spec description could inject executable code into every generated file (e2521d6)
...
- Close the remaining spec-string injection surfaces in the emitters. (d452a6c)
...
- Two generator bugs, both silent (5c213ea)
