...
export default defineNodeConfig({
  ...
  //
  // Already moved five times in this PR: `cli/report.ts` 40 -> 98,
  // `emit/mock.ts` 77 -> 98, `emit/schema.ts` 71 -> 87, `core/naming.ts`
  // 79 -> 97 and `input/openapi.ts` 79 -> 87 — 84.46 -> 90.69 for the package.
  // Recording a floor and then leaving it is how debt entries become permanent.
