 ...
 */
import { el, txt, DISPLAY, MONO, type InputEl } from './kit'
...
export const BrandSub = txt
  .attrs({ tag: 'span' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '9.5px', color: t.faint, extendCss: 'letter-spacing:.08em;' }))

export const NavTabs = el
  .attrs({ tag: 'nav', contentDirection: 'inline', gap: 4 })
  .theme((t) => ({ background: t.surface2, padding: '4px', borderRadius: '12px', flex: 'none' }))
...
export const HealthDot = el
  .attrs({ tag: 'span' })
  .states((t) => ({ ok: { background: t.ok }, bad: { background: t.danger } }))
...
export const HealthText = txt
  .attrs({ tag: 'span' })
  .states((t) => ({ ok: { color: t.ok }, bad: { color: t.danger } }))
...
export const GroupNum = txt.attrs({ tag: 'span' }).theme((t) => ({ fontFamily: MONO, fontSize: '10px', color: t.accent }))
export const GroupGlyph = txt.attrs({ tag: 'span' }).theme((t) => ({ fontFamily: MONO, fontSize: '10px', color: t.faint }))
export const GroupLabel = txt.attrs({ tag: 'span' }).theme(() => ({ flex: '1' }))
export const GroupCount = txt.attrs({ tag: 'span' }).theme((t) => ({ fontFamily: MONO, fontSize: '10px', color: t.faint }))
...
export const PkgBar = el
  .attrs({ tag: 'span' })
  .states((t) => ({ idle: { background: 'transparent' }, active: { background: t.accent } }))
...
export const SideEmpty = el
  .attrs({ tag: 'div' })
  .theme((t) => ({ textAlign: 'center', padding: '44px 16px', color: t.faint, fontFamily: MONO, fontSize: '12px', extendCss: 'line-height:1.5;' }))
...
export const CyclesDot = el
  .attrs({ tag: 'span' })
  .theme((t) => ({ width: '8px', height: '8px', borderRadius: '50%', flex: 'none', background: t.danger }))
...
export const Eyebrow = txt
  .attrs({ tag: 'div' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '11px', color: t.faint, marginBottom: '16px' }))
export const H1 = txt
  .attrs({ tag: 'h1' })
  .theme(() => ({
...
export const EmptyGlyph = txt
  .attrs({ tag: 'div' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '20px', color: t.ok, marginBottom: '8px' }))
...
export const CycleMeta = txt.attrs({ tag: 'span' }).theme((t) => ({ fontFamily: MONO, fontSize: '11px', color: t.faint }))
export const CycleSev = txt
  .attrs({ tag: 'span' })
  .variants((t) => ({ high: { color: t.danger }, medium: { color: t.warn } }))
...
export const CycleArrow = txt.attrs({ tag: 'span' }).theme((t) => ({ fontFamily: MONO, fontSize: '12px', color: t.faint }))
...
export const StatLabel = txt
  .attrs({ tag: 'div' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '9.5px', color: t.faint, marginBottom: '8px', extendCss: 'letter-spacing:.12em;' }))
...
export const ImpactRank = txt
  .attrs({ tag: 'span' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '10.5px', color: t.faint, width: '24px', flex: 'none' }))
...
export const ImpactFill = el
  .attrs({ tag: 'span' })
  .variants((t) => ({ accent: { background: t.accent }, danger: { background: t.danger } }))
  .theme(() => ({ display: 'block', height: '100%', borderRadius: '20px', extendCss: 'transition:width .3s;' }))
export const ImpactCount = txt
  .attrs({ tag: 'span' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '11.5px', width: '112px', flex: 'none', textAlign: 'right', color: t.muted }))
...
export const KindDot = el
  .attrs({ tag: 'span' })
  .variants((t) => ({ internal: { background: t.accent }, external: { background: t.ext } }))
...
export const PanelSection = txt
  .attrs({ tag: 'div' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '9.5px', color: t.faint, margin: '20px 0 8px', extendCss: 'letter-spacing:.12em;' }))
...
export const CycleWarnTitle = txt
  .attrs({ tag: 'div' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '9.5px', color: t.danger, marginBottom: '4px', extendCss: 'letter-spacing:.12em;' }))
export const CycleWarnText = txt
  .attrs({ tag: 'div' })
  .theme((t) => ({ fontSize: '12.5px', color: t.muted, extendCss: 'line-height:1.5;' }))
/**
...
export const MetricLabel = txt.attrs({ tag: 'span' }).theme((t) => ({ fontSize: '12.5px', color: t.muted }))
export const MetricValue = txt
  .attrs({ tag: 'span' })
  .variants((t) => ({ plain: { color: t.text }, muted: { color: t.muted }, warn: { color: t.warn }, ok: { color: t.ok }, danger: { color: t.danger } }))
  .theme(() => ({ fontFamily: MONO, fontSize: '12px' }))
export const DepChip = el
  .attrs({ tag: 'button' })
  .variants((t) => ({ internal: { color: t.accent }, external: { color: t.ext } }))
  .theme((t) => ({
...
export const PanelNote = txt.attrs({ tag: 'div' }).theme((t) => ({ fontSize: '12.5px', color: t.faint, padding: '8px 0' }))
...
export const FootSep = txt.attrs({ tag: 'span' }).theme((t) => ({ color: t.border }))
export const FootDanger = txt
  .attrs({ tag: 'span' })
  .variants((t) => ({ danger: { color: t.danger }, ok: { color: t.ok }, warn: { color: t.warn } }))
  .theme(() => ({}))
...
export const MatrixNote = txt
  .attrs({ tag: 'div' })
  .theme((t) => ({ fontFamily: MONO, fontSize: '10.5px', color: t.faint, marginBottom: '8px' }))
...
export const MatrixColLabel = txt
  .attrs({ tag: 'span' })
  .states((t) => ({ idle: { color: t.faint }, active: { color: t.accent } }))
  .theme(() => ({
...
export const MatrixRowLabel = el
  .attrs({ tag: 'button' })
  .states((t) => ({ idle: { color: t.muted }, active: { color: t.accent } }))
  .theme(() => ({
...
export const MatrixDiag = el
  .attrs({ tag: 'span' })
  .theme((t) => ({ width: '4px', height: '4px', borderRadius: '50%', background: t.border, extendCss: 'opacity:.6;' }))
...
export const MatrixCellDot = el
  .attrs({ tag: 'span' })
  .variants((t) => ({ dep: { background: t.accent }, back: { background: t.danger } }))
  .states(() => ({
...
export const SearchEmpty = el
  .attrs({ tag: 'div', contentDirection: 'rows', contentAlignX: 'center' })
  .theme((t) => ({ padding: '32px 16px', color: t.faint, fontSize: '13px', textAlign: 'center' }))
