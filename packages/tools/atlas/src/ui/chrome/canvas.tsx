...
export const Frame = el
  ...
  .theme((t: T) => cx(`border-radius:16px;overflow:hidden;box-shadow:0 20px 50px -24px rgba(15,18,30,.35);border:1px solid ${t.border};background:${t.surface};transition:width .16s ease;`))
  .sizes(() => ({
    vFull: {},
