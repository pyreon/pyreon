...
Pyreon-specific linter — 132 rules across 25 categories, CLI + LSP + programmatic API.
...
Full docs: [pyreon.dev/docs/lint](https://pyreon.dev/docs/lint) (or `docs/src/content/docs/lint.md` in this repo).
