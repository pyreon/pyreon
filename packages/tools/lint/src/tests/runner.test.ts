...
describe('Rule metadata', () => {
  it('should have 85 rules', () => {
    expect(allRules.length).toBe(85)
  })
...
describe('Presets', () => {
  it('recommended should include all rules (opt-in ones forced off)', () => {
    ...
    expect(Object.keys(config.rules).length).toBe(85)
