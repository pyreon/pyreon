...
- [#2622](https://github.com/pyreon/pyreon/pull/2622) [`b315e7a`](https://github.com/pyreon/pyreon/commit/b315e7a01ca87a8931192d8b2ee02388c8aac08b) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Add asymmetric enter/leave transition timing, and give the numeric timing vocabulary a web implementation it never had.
...
- [#2620](https://github.com/pyreon/pyreon/pull/2620) [`66b1a18`](https://github.com/pyreon/pyreon/commit/66b1a1888fb4725b4b3c3440278f559dfb4f7cc8) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Fix three emit bugs that made the natural session-rehydration and form-submit shapes uncompilable on both native targets.
...
- [#2621](https://github.com/pyreon/pyreon/pull/2621) [`55cca94`](https://github.com/pyreon/pyreon/commit/55cca9433dd43dd0b0849a50ae2b3b357999bb7a) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Fix two Compose layout bugs in the `@pyreon/coolgrid` `<Col>` lowering, both found by measuring real geometry on a device.
...
- [#2593](https://github.com/pyreon/pyreon/pull/2593) [`f9b8abc`](https://github.com/pyreon/pyreon/commit/f9b8abc0c4e5f84f0f79a65f4ba93dba55a5843e) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Fix two PMTC emit bugs that made `<Modal>` non-functional and `<Link>`
...
- [#2572](https://github.com/pyreon/pyreon/pull/2572) [`fc58ea0`](https://github.com/pyreon/pyreon/commit/fc58ea08345bad48d28d6eea0ad2283e67c93248) Thanks [@vitbokisch](https://github.com/vitbokisch)! - The flagship device-proven example used native-only idioms and a wrong import.
  ...
  `Locate` button ([#2570](https://github.com/pyreon/pyreon/issues/2570)) that also used `onClick`, which this change converts
...
- [#2570](https://github.com/pyreon/pyreon/pull/2570) [`84f1d67`](https://github.com/pyreon/pyreon/commit/84f1d6783c6400a20a881ead7b511cc99f7c2add) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Maps/geolocation reaches a BEHAVIORAL R4 on iOS — the matrix row's first non-zero score.
  ...
  1. No web half at all — `import { useGeolocation } from '@pyreon/hooks'` did
     not resolve, so the hook was native-only in practice ([#2567](https://github.com/pyreon/pyreon/issues/2567)).
  2. `geo.start()` did not build on Android — Swift's is 0-arg, Kotlin's took a
     ...
     geolocation could not be added to the shared counter at all ([#2569](https://github.com/pyreon/pyreon/issues/2569)).
  3. An interpolated `Double?` rendered `Optional(37.3349)` instead of the
     value ([#2566](https://github.com/pyreon/pyreon/issues/2566)).
...
- [#2596](https://github.com/pyreon/pyreon/pull/2596) [`9a963f0`](https://github.com/pyreon/pyreon/commit/9a963f09417d2172fc67480608b40a7c405b71b2) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Fix `emitKotlinToggle` silently dropping `data-testid` — the `<Link>` bug's
...
- [#2535](https://github.com/pyreon/pyreon/pull/2535) [`624a51e`](https://github.com/pyreon/pyreon/commit/624a51e5efb2db8de337cf75f5f7e05f741543e5) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Device-assert `accessibilityLabel` on Android — it had no coverage at all.
...
- [#2546](https://github.com/pyreon/pyreon/pull/2546) [`eec2612`](https://github.com/pyreon/pyreon/commit/eec2612bd7fd7ae0da13a2c7af89a393bb103110) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `attrs(Text)` — the form the library actually exposes — emitted uncompilable
  native code.
...
- [#2530](https://github.com/pyreon/pyreon/pull/2530) [`0734f52`](https://github.com/pyreon/pyreon/commit/0734f529366f2b298c453a5e9abdf1c326258b35) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `useClipboard()` had no type-gate coverage on either target.
  ...
  labels ([#2514](https://github.com/pyreon/pyreon/issues/2514)): a capability whose emit is never type-checked is a capability
...
- [#2535](https://github.com/pyreon/pyreon/pull/2535) [`624a51e`](https://github.com/pyreon/pyreon/commit/624a51e5efb2db8de337cf75f5f7e05f741543e5) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Half the documented control-flow vocabulary silently emitted uncompilable
  native code.
...
- [#2527](https://github.com/pyreon/pyreon/pull/2527) [`4479761`](https://github.com/pyreon/pyreon/commit/447976119d3948ff11487b72fa8b7f8322cdda6e) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `useDatabase` reaches R4 on iOS — a record that survives a real relaunch.
...
- [#2525](https://github.com/pyreon/pyreon/pull/2525) [`33d6aed`](https://github.com/pyreon/pyreon/commit/33d6aed2a65c00869042398fb95dfb2cfe6a6da0) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `useDatabase()` did not persist — on either platform.
...
- [#2577](https://github.com/pyreon/pyreon/pull/2577) [`4d91b74`](https://github.com/pyreon/pyreon/commit/4d91b74d4ba57a06993aa2a0c5c4abf1bd9901f0) Thanks [@vitbokisch](https://github.com/vitbokisch)! - An empty object literal `{}` emitted Void — silently on Swift.
...
- [#2535](https://github.com/pyreon/pyreon/pull/2535) [`624a51e`](https://github.com/pyreon/pyreon/commit/624a51e5efb2db8de337cf75f5f7e05f741543e5) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Lock the platform escape hatches, because two new warnings now depend on them.
...
- [#2552](https://github.com/pyreon/pyreon/pull/2552) [`6e12444`](https://github.com/pyreon/pyreon/commit/6e12444740b86b0749d093c2f029739721968689) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `@pyreon/form` was device-proven on native — via source that cannot compile on web.
...
- [#2580](https://github.com/pyreon/pyreon/pull/2580) [`b40ebfc`](https://github.com/pyreon/pyreon/commit/b40ebfc6ba6bee6ec24a1fbebddd3d78960096d5) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `isAvailable()` was documented on the shared picker surface and implemented on one of three targets.
...
- [#2566](https://github.com/pyreon/pyreon/pull/2566) [`4cb8c0b`](https://github.com/pyreon/pyreon/commit/4cb8c0b666039e5889cca21366a776c452e6a78a) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Optional service fields rendered `Optional(37.3349)` on iOS instead of `37.3349`.
...
- [#2525](https://github.com/pyreon/pyreon/pull/2525) [`33d6aed`](https://github.com/pyreon/pyreon/commit/33d6aed2a65c00869042398fb95dfb2cfe6a6da0) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `useStorage()` did not persist on Android.
...
- [#2560](https://github.com/pyreon/pyreon/pull/2560) [`cddba1e`](https://github.com/pyreon/pyreon/commit/cddba1e796f84b68b41f51e4d7a6b59542615252) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `const { store } = useApp()` failed both native targets with zero warnings.
...
- [#2579](https://github.com/pyreon/pyreon/pull/2579) [`3df5fbb`](https://github.com/pyreon/pyreon/commit/3df5fbbb056d9805cf326d264ad89b1f22807ba1) Thanks [@vitbokisch](https://github.com/vitbokisch)! - The concise defineStore setup failed both targets silently — and the warning written for it was unreachable.
...
- [#2535](https://github.com/pyreon/pyreon/pull/2535) [`624a51e`](https://github.com/pyreon/pyreon/commit/624a51e5efb2db8de337cf75f5f7e05f741543e5) Thanks [@vitbokisch](https://github.com/vitbokisch)! - A Pyreon hook with no native lowering emitted uncompilable code, silently.
...
- [#2546](https://github.com/pyreon/pyreon/pull/2546) [`eec2612`](https://github.com/pyreon/pyreon/commit/eec2612bd7fd7ae0da13a2c7af89a393bb103110) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `const p = useParams()` then `p.id` failed on both native targets, silently.
...
- [#2587](https://github.com/pyreon/pyreon/pull/2587) [`f110299`](https://github.com/pyreon/pyreon/commit/f110299aed1c8af97f9940e4a70378d0bcd0a31d) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Content-address the native compile-validation harness so `swiftc` / `kotlinc`
...
- [#2532](https://github.com/pyreon/pyreon/pull/2532) [`97768d7`](https://github.com/pyreon/pyreon/commit/97768d7199df07394bb0bad4311c1e08d25bd047) Thanks [@vitbokisch](https://github.com/vitbokisch)! - A rocketstyle dimension written as an object of FUNCTIONS dropped every style,
  silently.
...
- [#2574](https://github.com/pyreon/pyreon/pull/2574) [`5439bd3`](https://github.com/pyreon/pyreon/commit/5439bd3dce309640cf16e4c35aa8107a4c9b45f7) Thanks [@vitbokisch](https://github.com/vitbokisch)! - coolgrid compiled on Kotlin and failed on Swift — the gate was wrong, not the emit.
...
- [#2575](https://github.com/pyreon/pyreon/pull/2575) [`06c743d`](https://github.com/pyreon/pyreon/commit/06c743d9b9d12915f970d42674273bce2eef4a8f) Thanks [@vitbokisch](https://github.com/vitbokisch)! - The Swift gate REJECTED valid i18n source — a stub that was stricter than the runtime.
...
- [#2614](https://github.com/pyreon/pyreon/pull/2614) [`9154c8a`](https://github.com/pyreon/pyreon/commit/9154c8aca81ce858ef99b213564af870c378f37f) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Fix the Swift emit producing `ws.isConnected()` / `ws.lastMessage()` /
