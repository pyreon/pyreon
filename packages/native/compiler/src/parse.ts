...
export const UNLOWERED_PYREON_MODULES: ReadonlyMap<string, UnloweredModule> = new Map([
  ...
  [
    '@pyreon/flow',
    {
      ...
      supported: new Set(['createFlow', 'useFlow', 'computeLayout', 'getBezierPath', 'getSmoothStepPath', 'getStepPath', 'getStraightPath', 'getWaypointPath', 'getEdgePath', 'getHandlePosition', 'getNodeIntersection', 'DEFAULT_NODE_WIDTH', 'DEFAULT_NODE_HEIGHT', 'Position', 'Flow', 'Background', 'Controls', 'MiniMap', 'Panel']),
    },
  ],
  [
    '@pyreon/charts',
