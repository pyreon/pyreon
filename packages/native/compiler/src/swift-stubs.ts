...
public final class PyreonFlowState<T> {
  ...
  public var autoHistory = true; public var historyLimit = 50; public var deleteKeys: [String]? = ["Delete", "Backspace"]; public var multiSelectionKey: String? = "shift"; public var selectionKey: String? = "shift"; public var zoomActivationKey: String? = "ctrl"; public var preventScrolling = true
