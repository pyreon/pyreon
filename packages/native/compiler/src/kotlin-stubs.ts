...
class PyreonFlowState<T>(
  ...
  deleteKeys: List<String>? = listOf("Delete", "Backspace"),
  multiSelectionKey: String? = "shift",
  selectionKey: String? = "shift",
  zoomActivationKey: String? = "ctrl",
