...
- [#2635](https://github.com/pyreon/pyreon/pull/2635) [`d85bbf7`](https://github.com/pyreon/pyreon/commit/d85bbf7af4cd1e58ce8eed29b12b2330d9ea8b1b) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Add inbound deep links — the path an app is opened at, and the paths it is sent while already running.
