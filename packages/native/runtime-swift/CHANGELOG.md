...
- [#2637](https://github.com/pyreon/pyreon/pull/2637) [`470af1d`](https://github.com/pyreon/pyreon/commit/470af1d00384149b03173bc7ba2d7f9a8b484eff) Thanks [@vitbokisch](https://github.com/vitbokisch)! - `PyreonWebSocket.isConnected` now flips on the real handshake, not on `resume()`.
