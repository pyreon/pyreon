...
// Source: packages/fundamentals/charts/src/engine/*.ts (35 modules)
...
public struct Series {
  ...
  public init(kind: String, values: [Double], color: String, width: Double, radius: Double, label: String, curve: (([PyreonChartPt]) -> [PyreonChartPt])? = nil, showValues: Bool? = nil, radii: [Double]? = nil, axis: String? = nil, effect: Bool? = nil, symbol: String? = nil, symbolRepeat: Bool? = nil, corners: [Double]? = nil) {
    self.kind = kind
    self.values = values
    self.color = color
    self.width = width
...
public struct GraphOptions: Codable {
  ...
  public var linkColor: String? = nil
  public var progress: Double? = nil
  public init(layout: String? = nil, categories: [String]? = nil, symbolSize: Double? = nil, iterations: Double? = nil, repulsion: Double? = nil, linkDistance: Double? = nil, gravity: Double? = nil, seed: Double? = nil, showLabels: Bool? = nil, labelColor: String? = nil, fontSize: Double? = nil, linkColor: String? = nil, progress: Double? = nil) {
    self.layout = layout
    self.categories = categories
    self.symbolSize = symbolSize
    self.iterations = iterations
...
public struct ParallelOptions: Codable {
  ...
  public var progress: Double? = nil
  public init(fontSize: Double? = nil, labelColor: String? = nil, axisColor: String? = nil, lineColor: String? = nil, lineColors: [String]? = nil, lineOpacity: Double? = nil, lineWidth: Double? = nil, highlight: [Double]? = nil, highlightColor: String? = nil, progress: Double? = nil) {
    self.fontSize = fontSize
    self.labelColor = labelColor
    self.axisColor = axisColor
...
private let GANTT_PALETTE = ["#2563eb", "#16a34a", "#f59e0b", "#dc2626", "#7c3aed", "#0891b2", "#db2777", "#65a30d"]

private let PARALLEL_PALETTE = ["#0f766e", "#b45309", "#1d4ed8", "#b42318", "#15803d", "#7c3aed"]
...
public func rectCmd(_ rect: PyreonChartRect, _ fill: String, _ corners: [Double]?) -> PyreonDrawCmd {
    if corners == nil {
...
public func renderChart(_ spec: ChartSpec, _ measure: (String, Double) -> Double) -> [PyreonDrawCmd] {
    ...
    if stackedSeries.count > 0 {
      for seg in layoutStackedBars(stackedSeries.map({ s in s.values }), plot, yDomain, 0.25) {
        ...
        out.append(rectCmd(rS, stackedSeries[seg.seriesIndex].color, stackedSeries[seg.seriesIndex].corners))
    ...
    if groupedSeries.count > 0 {
      for seg in layoutGroupedBars(groupedSeries.map({ s in s.values }), plot, yDomain, 0.25) {
        ...
        out.append(rectCmd(rG, groupedSeries[seg.seriesIndex].color, groupedSeries[seg.seriesIndex].corners))
    ...
    for s in spec.series {
      ...
      if spec.horizontal == true {
        ...
        for r in rects {
          ...
          if s.symbol == nil {
            out.append(rectCmd(grown, s.color, s.corners))
          } else {
...
public func layoutGraph(_ nodes: [GraphNode], _ links: [GraphLink], _ box: PyreonChartRect, _ options: GraphOptions? = nil) -> GraphLayout {
    ...
    for i in 0..<n {
      let nd = nodes[i]
      let cat = nd.category
      let color = (nd.color ?? GRAPH_PALETTE[((cat ?? i)) % GRAPH_PALETTE.count])
...
public func layoutGantt(_ tasks: [GanttTask], _ box: PyreonChartRect, _ options: GanttOptions? = nil, _ measure: ((String, Double) -> Double)? = nil) -> GanttLayout {
    ...
    let m = (measure ?? approxTextWidth)
    let palette = (options?.palette ?? GANTT_PALETTE)
    var sDay: [Double] = []
    var eDay: [Double] = []
    for task in tasks {
...
public func layoutParallel(_ axes: [ParallelAxis], _ rows: [[Double]], _ box: PyreonChartRect, _ options: ParallelOptions? = nil) -> ParallelLayout {
    ...
    let fallback = (options?.lineColor ?? PARALLEL_PALETTE[0])
    for i in 0..<rows.count {
      let row = rows[i]
      var points: [PyreonChartPt] = []
      var present: [Bool] = []
