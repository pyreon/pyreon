...
registerSingleton('@pyreon/zero', '0.24.6', import.meta.url)
...
export { buildLocalePath, extractLocaleFromPath, setLocale, useLocale } from './i18n-routing'
