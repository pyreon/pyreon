...
- Built-artifact specs no longer skip silently (61e0482)
...
- [#2167](https://github.com/pyreon/pyreon/pull/2167) [`4ae3793`](https://github.com/pyreon/pyreon/commit/4ae3793ab53866be3d057260f3cbe9a213bf7a3b) Thanks [@vitbokisch](https://github.com/vitbokisch)! - Store excellence pass — scope ownership, plugin cleanups, dev diagnostics, patch fast-path.
  ...
  **Features:**
  ...
  - **Dev diagnostics** (folded out of production): `patch()` warns on unknown keys (previously a fully silent no-op — the [#1](https://github.com/pyreon/pyreon/issues/1) documented patch footgun); `defineStore` warns once per id when a registry hit was created from a DIFFERENT setup function (two-definitions-one-id, or the HMR silent-stale shape).
