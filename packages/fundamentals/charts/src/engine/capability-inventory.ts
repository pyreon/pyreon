...
export const CHART_CAPABILITIES: readonly ChartCapability[] = [
  ...
  row('coordinates.axes', 'coordinates', 'direct', 'partial', 'src/engine/option-axes.test.ts', '../../native/compiler/src/tests/chart-axes-native.test.ts'), // names, show, grid, log, inverse x and y, position, dual y on both targets; open: offset, 3+ y / 2+ x axes
