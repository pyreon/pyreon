...
export const CHART_CAPABILITIES: readonly ChartCapability[] = [
  ...
  row('coordinates.axes', 'coordinates', 'direct', 'partial', 'src/engine/option-axes.test.ts', '../../native/compiler/src/tests/chart-axes-native.test.ts'), // names, show, grid, log, inverse x and y, position, offset, dual and extra y axes on both targets; open: a second x axis
