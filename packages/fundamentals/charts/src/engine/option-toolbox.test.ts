...
describe('option.toolbox', () => {
  it('maps every ECharts feature, and names a custom tool and a y-axis box zoom', () => {
    ...
    expect(t).toMatchObject({ saveAsImage: true, imageType: 'svg', name: 'q3', restore: true, dataView: true, dataZoom: true, magicType: ['line', 'stack'] })
    expect(w).toEqual(['toolbox.feature.dataZoom.yAxisIndex', 'toolbox.feature.magicType.type', 'toolbox.feature.myTool', 'toolbox.feature.brush'])
  })
