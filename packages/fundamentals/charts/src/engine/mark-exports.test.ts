...
// `@pyreon/charts`: they existed, they lowered to native, the manifest
// listed them as importable bindings — and `import { waterfall } from
// '@pyreon/charts'` was undefined. Nothing caught it, because the only
...
describe('the mark surface is reachable', () => {
  it('every mark factory is exported from @pyreon/charts', () => {
