...
const ROLE: Readonly<Record<keyof Series, Role>> = {
  ...
  label: 'presentation',
  curve: 'presentation',
  smoothAmount: 'presentation',
  smoothMonotone: 'presentation',
  connectNulls: 'presentation',
  areaFill: 'presentation',
  areaOpacity: 'presentation',
  areaColor: 'presentation',
  areaOrigin: 'presentation',
  areaOriginAt: 'presentation',
  labelPosition: 'presentation',
  labelDistance: 'presentation',
  labelRotate: 'presentation',
  labelOffset: 'presentation',
  labelAlign: 'presentation',
  labelVerticalAlign: 'presentation',
  labelBorderColor: 'presentation',
  labelBorderWidth: 'presentation',
  ...
  inBrush: 'presentation',
  brushOpacity: 'presentation',
  emphasisScale: 'presentation',
  emphasisDisabled: 'presentation',
  emphasisWidth: 'presentation',
  blurWidth: 'presentation',
  emphasisAreaOpacity: 'presentation',
  blurAreaOpacity: 'presentation',
  emphasisLabel: 'presentation',
  selectLabel: 'presentation',
  seriesSelected: 'presentation',
}
