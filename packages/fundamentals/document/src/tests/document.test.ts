    ...
    const doc = Document({
      ...
      children: Page({
        children: Column({
          ...
          // Simulate untrusted data reaching the renderer through a
          // typed prop (cast forces the malicious string past the type).
          align: 'left"><img src=x onerror=alert(3)>' as unknown as 'center',
