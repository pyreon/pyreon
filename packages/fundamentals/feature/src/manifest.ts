...
/>`,
    ...
    },
    {
      name: 'Field',
      kind: 'component',
      signature: '<Feature.Field form={form} name="title" />',
      summary:
      ...
      example: `const form = Posts.useForm()
