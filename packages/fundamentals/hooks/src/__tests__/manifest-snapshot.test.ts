...
describe('gen-docs — hooks snapshot', () => {
  ...
  it('renders @pyreon/hooks to MCP api-reference entries — one per api[] item', () => {
    ...
    expect(Object.keys(record).length).toBe(49)
