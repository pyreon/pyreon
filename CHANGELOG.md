...
- **@pyreon/store** — Global state management: `defineStore`, `resetStore`, `resetAllStores`, SSR isolation via `setStoreRegistryProvider`
...
- **@pyreon/model** — Reactive models: signal-backed state, computed views, actions, JSON patch tracking, snapshots, middleware
